...
public class SearchController {
    ...
    public void searchIndex(@RequestParam String term){
        List<String> cities = Arrays.asList("Ankara", "İstanbul", "Mersin", "Zonguldak", "Malatya", "Elezığ", "Hakkari", "İzmir");
        List<String> products = Arrays.asList("Bebek BEzi", "Cep telefonu", "Klavye", "Mause", "Bardak", "Cüzdan", "Laptop", "Ampül");
